...
* **Telas de Login:**
    ...
    |![Primeiro Acesso](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/PrimeiroAcesso.png?raw=true) |![Login](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Login/Login.png?raw=true) |
    |---|---|

* **Telas do Primeiro Cadastro:**
  
    |![Cadastro](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Contract_Terms/Cadastro.png?raw=true) |![Termos do Contrato](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Contract_Terms/TermosContrato.png?raw=true) |![Contrato Aceito](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Contract_Terms/CadastroSucesso.png?raw=true) |
    |---|---|---|

* **Telas de Login Alternativo:**

    | ![Login com Google](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Login/LoginGoogle.png?raw=true) |![Login com Facebook](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Login/LoginFacebook.png?raw=true) |![Login com Apple ID](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Login/LoginAppleID.png?raw=true) |
    |---|---|---|

* **Telas de Opções e Configurações:**

    | ![Tela Inicial](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Home_and_Options/Home.png?raw=true) | ![Seleção de Fase](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Home_and_Options/SelecaoCategoria.png?raw=true) | ![Opções](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Home_and_Options/Opcoes.png?raw=true) | ![Suporte](https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/Home_and_Options/Suporte.png?raw=true) |
    |---|---|---|---|

* **Telas de Modos de Uso:**

    | ![Cálculos](https://raw.githubusercontent.com/tarcisioribeiro/AlfabetizeAi/main/Prototipo/Assets/Images/Categories/Calculos/Calculos.png) | ![Letras e Palavras](https://raw.githubusercontent.com/tarcisioribeiro/AlfabetizeAi/main/Prototipo/Assets/Images/Categories/Letras_e_Palavras/Letras_e_Palavras.png) | ![Imagens](https://raw.githubusercontent.com/tarcisioribeiro/AlfabetizeAi/main/Prototipo/Assets/Images/Categories/Imagens/Imagens.png) |
    |---|---|---|
...
* **Obs: Para acessar o vídeo de apresentação, clique na imagem abaixo. O vídeo pode estar desatualizado.**
    ...
    <div style="text-align: center;"><a href="https://www.youtube.com/watch?v=1g5z5F4855k"><img src="https://github.com/tarcisioribeiro/AlfabetizeAi/blob/main/Prototipo/Assets/Images/PrimeiroAcesso.png?raw=true" alt="APEDC (Primeira Versão)"></a></div>
